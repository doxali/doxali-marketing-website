    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-black text-[var(--foreground)]">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-4 py-16">
        <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-md p-6 md:p-10 space-y-6">
          ...
          <p>
            All purchases made through Doxali are final once your document extraction has been processed. We encourage you to review your file selection and document type carefully before confirming payment.
          </p>
          <p>
          ...
          <p>
            Doxali is not responsible for incomplete or inaccurate input provided by the user that results in suboptimal extraction output.
          </p>
