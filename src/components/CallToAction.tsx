...
export default function Newsletter2() {
  ...
  return (
    <section
      ref={ref}
      className="relative overflow-hidden pt-8 md:pt-1 pb-8 md:pb-40 bg-gradient-to-t from-[#d1fae5] to-white dark:from-[#2a2a2a] dark:via-[#111111] dark:to-black text-[#0c1f1b] dark:text-white"
      // NOTE: removed min-h-screen so height collapses to content
    >
      ...
      >
        {/* Headline */}
        <h2
          className={`text-5xl sm:text-6xl lg:text-7xl font-black tracking-tight mb-5 transition-all duration-1000 delay-500 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
          }`}
        >
          <span className="bg-gradient-to-r from-[#2fc4a0] to-[#2fc4a0] bg-clip-text text-transparent">
            Document Extraction
          </span>
          <br />
        ...
        {/* Badge */}
        <div
          className={`inline-flex items-center px-4 py-2 rounded-full bg-[#2fc4a0]/10 border border-[#2fc4a0]/20 mb-6 transition-all duration-1000 delay-300 ${
        ...
        {/* Subtitle */}
        <p
          className={`text-xl sm:text-2xl text-slate-700 dark:text-slate-300 mb-8 max-w-3xl mx-auto leading-relaxed transition-all duration-1000 delay-700 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
          Experience the future of document analysis with{' '}
          <span className="text-[#2fc4a0] font-semibold">AI Precision</span> that understands Context, Extracts
          highlights, and delivers faster results for your team.
        </p>

        {/* Feature highlights with icons */}
        <div
          className={`flex flex-wrap justify-center gap-4 mb-8 transition-all duration-1000 delay-900 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
          {[
        ...
        {/* CTA Button */}
        <div
          className={`mb-6 transition-all duration-1000 delay-1100 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
          }`}
        >
          <a
            href="/launch"
            className="group inline-flex items-center justify-center px-8 py-4 text-lg font-bold text-white bg-[#2fc4a0] rounded-2xl shadow-xl hover:bg-[#26b396] transition-all duration-300 hover:scale-105 hover:-translate-y-1"
          >
